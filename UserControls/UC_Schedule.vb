...
' -------------------------------------------
' ოპტიმიზირებული განრიგის UserControl (ძველი სახელით)
' ფუნქციონალი გატანილია ცალკეულ სერვისებში წარმადობისა და ორგანიზაციისთვის
' შენარჩუნებულია თავდაპირველი API და ინტერფეისი
' ===========================================
...
#Region "პირადი მეთოდები - ოპტიმიზირებული იმპლემენტაცია"
    ...
    Private Sub InitializeServices()
        Try
            ...
            ' ComboBox-ების შევსება ფონზე (პერფორმანსისთვის)
    ...
    Private Sub PopulateComboBoxesAsync()
        Try
            ...
            Me.Invoke(Sub() filterManager.PopulateFilterComboBoxes(dataProcessor))
        Catch ex As Exception
